...
export function ResultsClientWrapper({
  ...
  const handleDownloadReport = () => {
    // Simply open the PDF preview dialog
  ...
  return (
    <>
      ...
      {/* Hidden PDF Template - Only used for printing */}
      ...
      <div className="space-y-8 print:hidden" ref={contentRef}>
        {/* Header Summary */}
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Download a professional PDF report with all comparison results
                </p>
              </div>
